class ProductsController < ApplicationController
  ...
  def create
     @product = current_user.products.build(product_params)
      if @product.save
        @product.client.update("Check out #{@product.title} on www.upveil.com/categories/#{@product.category.slug}/products/#{@product.category.slug} ##{@product.category.title}")
        @product.update_rank
